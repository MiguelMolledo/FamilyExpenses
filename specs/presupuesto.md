...
- Prescindible: se puede marcar una categoría entera (`is_flexible`) o subcategorías sueltas (tijeras en el desglose) como recortables en un bache. Alimenta dos vistas: capacidad de reacción (× gasto real, en Inicio) y «Modo supervivencia» en Presupuesto (× presupuesto): mínimo para vivir = presupuesto total − prescindible (sin contar ahorro), con la lista de lo que se cortaría y el colchón — cuántos meses daría la hucha en modo mínimo sin ingresos. Solo resta lo prescindible con importe asignado en el desglose; lo sin asignar es imprescindible (con aviso).
